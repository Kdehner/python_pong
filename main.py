...
def draw_game(win: Surface, paddles: [Paddle], ball: Ball, left_score, right_score):
    win.fill(BLACK)
...
def reset_game(ball: Ball, paddles: [Paddle]):
    ball.reset()
    for paddle in paddles:
        paddle.reset()
        
def win_game(win: Surface, win_text):
